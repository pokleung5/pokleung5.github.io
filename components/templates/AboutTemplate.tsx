...
export function AboutTemplate({ experiences, philosophy }: AboutTemplateProps) {
  return (
    <main className="relative mx-auto flex w-full max-w-6xl flex-col gap-16 px-4 pb-24 pt-28 sm:px-8">
      <section className="mt-8 max-w-4xl">
        <h1 className="gradient-text text-4xl font-bold sm:text-5xl">Architecting joyful systems.</h1>
        <p className="mt-6 text-lg text-foreground/70 sm:text-xl">
          Eric Leung is a software engineer who believes that sustainable systems are born from playful experimentation and rigorous care. From taming sprawling monoliths to prototyping immersive interfaces, he treats refactoring as an ongoing art form.
        </p>
      </section>
